---
title: "The LLFS RNAseq Database"
...
|-----------------|-------------------|----------|-----------------------------------------------------------|
| sample_id       |                   | INTEGER  | Primary key of the sample                                  |
| batch_id        |                   | INTEGER  | Foreign key to the batch table                             |
| batch_alias     |                   | TEXT     | Alias of the batch                                         |
| fastq_id        |                   | TEXT     | Foreign key to the fastq table                             |
| visit           |                   | TEXT     | Visit information for the sample                           |
| relabel_reason  |                   | TEXT     | Reason for relabeling the sample (or "NA" if not applicable)|
| mislabelled     |                   | INTEGER  | Indicator of whether the sample is mislabeled (0 or 1)      |
| suspicious_sex  |                   | INTEGER  | Indicator of whether the sample has suspicious sex (0 or 1) |
| legal           |                   | TEXT     | Reason for legal status ("yes" if not applicable)           |
| whatdatall_id   |                   | INTEGER  | Foreign key to the whatdatall table                        |
| subject         |                   | INTEGER  | Subject information for the sample                         |
| sex             |                   | INTEGER  | Sex information for the sample                             |
