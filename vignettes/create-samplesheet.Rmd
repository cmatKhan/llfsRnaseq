...
LOCAL_FASTQ_PREFIX = file.path(
  "/mnt/scratch/llfs_rnaseq_dataprocessing/llfs_rna_pipeline/data",
  FASTQ_DIR)

OUT_FASTQ_PREFIX = file.path(
  "/scratch/mblab/chasem/llfs_rnaseq_dataprocessing/llfs_rna_pipeline/data",
  FASTQ_DIR)
...
if(WRITE_OUT){
  write_csv(nf_samplesheet,
          file.path(
            "/mnt/scratch/llfs_rnaseq_dataprocessing/llfs_rna_pipeline",
            "sample_sheets",
            paste0(BATCH, ".csv")))
}
